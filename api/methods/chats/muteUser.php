...
if (($my_access_level >= $perms->getValue("can_mute") && $my_access_level > $working_user["flags"]["level"]))
{
	$result->changeWriteAccess($context['user_id'], $params['entity_id'], $working_user["flags"]["is_muted"], [
	...
	die(json_encode(array(
		'response' => intval(!$working_user["flags"]["is_muted"])
	)));
}

...
$user = new User($connection, $params['user_id']);
if (intval($user->profile['is_banned']))
...
$friends = get_friends_list($connection, $params['user_id'], "subscribers", $params['extended']);
$result  = [];

...
/**
 * API for friends deleting or requests declining
*/
...
if (!function_exists('delete_friendship'))
	require __DIR__ . '/../../../bin/functions/users.php';

die(json_encode(array('response'=>intval(delete_friendship($connection, $context['user_id'], $params['user_id'])))));
?>